...
add wave -noupdate -format Analog-Step -height 40 -max 32000.0 -min -32000.0 -radix decimal /tb/modem_rx_top_inst/dds_cos_o
add wave -noupdate -format Analog-Step -height 40 -max 32000.0 -min -32000.0 -radix decimal /tb/modem_rx_top_inst/dds_sin_o
...
add wave -noupdate /tb/modem_rx_top_inst/dds_cos
...
WaveRestoreCursors {{Cursor 1} {1108995411 ps} 0}
...
update
WaveRestoreZoom {1103924485 ps} {1114955485 ps}
