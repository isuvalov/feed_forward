...
`define ITERATION_BITS 5  // 2^ITERATION_BITS = ITERATIONS
...
`endif
  ...
  reg signed [`XY_BITS:0] y_1=0;
  reg signed [`THETA_BITS:0] z_1=0;
...
5'b00000: tanangle = 25'd13176795;
5'b00001: tanangle = 25'd7778716;
5'b00010: tanangle = 25'd4110060;
5'b00011: tanangle = 25'd2086331;
5'b00100: tanangle = 25'd1047214;
5'b00101: tanangle = 25'd524117;
5'b00110: tanangle = 25'd262123;
5'b00111: tanangle = 25'd131069;
5'b01000: tanangle = 25'd65536;
5'b01001: tanangle = 25'd32768;
5'b01010: tanangle = 25'd16384;
5'b01011: tanangle = 25'd8192;
5'b01100: tanangle = 25'd4096;
5'b01101: tanangle = 25'd2048;
5'b01110: tanangle = 25'd1024;
5'b01111: tanangle = 25'd512;
5'b10000: tanangle = 25'd256;
5'b10001: tanangle = 25'd128;
5'b10010: tanangle = 25'd64;
5'b10011: tanangle = 25'd32;
5'b10100: tanangle = 25'd16;
5'b10101: tanangle = 25'd8;
5'b10110: tanangle = 25'd4;
5'b10111: tanangle = 25'd2;
5'b11000: tanangle = 25'd1;
